    ...
    <div class="page-content">
        <div class="chat-wrapper">
                            ...
                            <div class="chat-list">
                                <div class="list-group list-group-flush">
                                    <a href="javascript:;" class="list-group-item">
                                        <div class="d-flex">
                                            <div class="chat-user-online">
                                                <img src="{{ !empty($question->user->photo) ? url('upload/user_images/' . $question->user->photo) : url('upload/no_image.jpg') }}"class="user-img"
                                                    alt="user avatar">
                                            </div>
                                            <div class="flex-grow-1 ms-2">
            ...
            <form action="{{ route('instructor.reply') }}" method="POST">
                ...
                <input type="tehiddenxt" name="instructor_id" value="{{ $profileData->id }}">
                ...
                <div class="chat-footer d-flex align-items-center">
                    ...
                    <div class="chat-footer-menu">
                        <button type="submit"><i class='lni lni-reply'></i>Sent</button>
