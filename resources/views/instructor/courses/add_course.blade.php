    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body p-4">
                ...
                <form action="{{ route('store.course') }}" method="post" id="myForm" class="row g-3"
                    ...
                    <div class="form-group col-md-6 text-secondary">
                        ...
                        <input oninput="showImage.src=window.URL.createObjectURL(this.files[0])" name="course_image"
                            type="file" class="form-control" id="image">
                    </div>

                    <div class="col-md-6">

                        <img id="showImage" src="{{ url('upload/no_image.jpg') }}" alt="Category img"
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <textarea class="form-control" id="myeditorinstance" name="description" placeholder="Description....."
                            rows="3"></textarea>
                    </div>
