...
<div class="page-content">
    ...
    <div class="card">
        <div class="card-body p-4">
            ...
            <form action="{{ route('update.course')}}" method="post" id="myForm"
             class="row g-3" enctype="multipart/form-data" >
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="course_name" class="form-control" value="{{ $course->course_name }}"  placeholder="Course Name">
                </div>

                <div class="form-group col-md-6">
                    <label for="input1" class="form-label">Course Title</label>
                    <input type="text" name="course_title" class="form-control" value="{{ $course->course_title }}"  placeholder="Course Title">
                </div>
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="text" name="selling_price" class="form-control" value="{{ $course->selling_price }}"  placeholder="Course Price">
                </div>


                <div class="form-group col-md-3">
                    <label for="input1" class="form-label">Discount Price</label>
                    <input type="text" name="discount_price" class="form-control"  value="{{ $course->discount_price }}"  placeholder="Discount Price">
                </div>

                <div class="form-group col-md-3">
                    <label for="input1" class="form-label">Duration</label>
                    <input type="text" name="duration" class="form-control"  value="{{ $course->duration }}"  placeholder="Duration">
                </div>

                <div class="form-group col-md-3">
                    <label for="input1" class="form-label">Resources</label>
                    <input type="text" name="resources" class="form-control"  value="{{ $course->resources }}"  placeholder="Resources">
                </div>

                <div class="form-group col-md-12">
                    <label for="input1" class="form-label">Course Prerequisites</label>
                    <textarea class="form-control" id="input11" name="prerequisites" placeholder="Prerequisites ..." rows="3"> {{ $course->prerequisites }}  </textarea>
                </div>

                <div class="form-group col-md-12">
                    <label for="input1" class="form-label">Course Description</label>
                    <textarea class="form-control" id="myeditorinstance" name="description" placeholder="Description....." rows="3">{!! $course->description !!}</textarea>
                </div>
    ...
    <div class="card">
        ...
        <input type="hidden" name="old_video" value="{{ $course->video }}">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
                <video width="300" height="130" controls > <source src="{{ asset($course->video) }}" type="video/mp4" > </video>
    ...
    $(document).ready(function (){
        $('#myForm').validate({
            ...
            messages :{
                ...
                label: {
                    required : 'Please Select Course label',
                },
                selling_price: {
