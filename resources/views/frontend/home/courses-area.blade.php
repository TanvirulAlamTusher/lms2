        ...
        <div class="container">
            <div class="tab-content" id="myTabContent">
                ...
                @foreach ($category as $cat_item)
                    <div class="tab-pane fade" id="business{{ $cat_item->id }}" role="tabpanel" aria-labelledby="design-tab">
                        <div class="row">
                            @php
                                  $catwiseCourse = App\Models\Course::where('category_id', $cat_item->id)->where('status',1)->orderBy('id','DESC')->get();
                            @endphp
                            ...
                            <div class="col-lg-4 responsive-column-half">
                                <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_2">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <h5 class="card-title"><a href="course-details.html">{{$course_item->course_title }}</a></h5>
                                        <p class="card-text"><a href="teacher-detail.html">{{ $course_item['user']['name'] }}</a></p>
                                        <div class="rating-wrap d-flex align-items-center py-2">
                                            <div class="review-stars">
                                                <span class="rating-number">4.4</span>
                                                <span class="la la-star"></span>
