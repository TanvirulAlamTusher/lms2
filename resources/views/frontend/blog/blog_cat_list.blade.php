    ...
    <div class="container">
        <div class="breadcrumb-content d-flex flex-wrap align-items-center justify-content-between">
            <div class="section-heading">
                <h2 class="section__title text-white">{{ $blog_cat_name->category_name }}</h2>
            </div>
        ...
        <div class="row">
                        ...
                        <div class="card card-item">
                            <div class="card-image">
                                <a href="{{ url('blog/details/'.$blog_post->post_slug) }}" class="d-block">
                                    <img class="card-img-top lazy" src="{{ asset($blog_post->post_image) }}" data-src="images/img8.jpg" alt="Card image cap">
                                </a>
                                <div class="course-badge-labels">
                                    <div class="course-badge">{{ $blog_post->created_at->format('d M  Y') }}</div>
                                </div>
                            </div><!-- end card-image -->
                            <div class="card-body">
                                <h5 class="card-title"><a href="{{ url('blog/details/'.$blog_post->post_slug) }}">{{ $blog_post->post_title}}</a></h5>
                                ...
                                <div class="d-flex justify-content-between align-items-center pt-3">
                                    <a href="{{ url('blog/details/'.$blog_post->post_slug) }}" class="btn theme-btn theme-btn-sm theme-btn-white">Read More <i class="la la-arrow-right icon ml-1"></i></a>
            ...
            <div class="col-lg-4">
                <div class="sidebar">
                    ...
                    <div class="card card-item">
                        <div class="card-body">
                            <h3 class="card-title fs-18 pb-2">Blog Catgories</h3>
