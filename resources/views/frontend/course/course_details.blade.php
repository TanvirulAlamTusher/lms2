                ...
                <div class="breadcrumb-content">
                    ...
                    <div class="d-flex flex-wrap align-items-center pt-3">
                        ...
                        @if ($course->featured == 1)
                            <h6 class="ribbon ribbon-lg mr-2 bg-3 text-white">Beatured</h6>
                        @else
                        @endif
            ...
            <div class="row">
                <div class="col-lg-8 pb-5">
                    <div class="course-details-content-wrap pt-90px">
                        ...
                        @php
                            $lecture = App\Models\CourseLecture::where('course_id', $course->id)
                                ->orderBy('id', 'asc')
                                ->get();
                        @endphp
                        ...
                        <div class="course-overview-card">
                            ...
                            <div class="curriculum-content">
                                <div id="accordion" class="generic-accordion">
                                    ...
                                    @foreach ($section as $sectnons)
                                        @php
                                            $section_lecture = App\Models\CourseLecture::where(
                                                'section_id',
                                                $sectnons->id,
                                            )->get();
                                        @endphp
                                        ...
                                        <div class="card">
                                            <div class="card-header" id="heading{{ $sectnons->id }}">
                                                <button
                                                    class="btn btn-link d-flex align-items-center justify-content-between"
                                                    data-toggle="collapse" data-target="#collapse{{ $sectnons->id }}"
                                                    aria-expanded="true" aria-controls="collapse{{ $sectnons->id }}">
                                                    <i class="la la-plus"></i>
                                                    <i class="la la-minus"></i>
                                                    {{ $sectnons->section_title }}
                                                    <span
                                                        class="fs-15 text-gray font-weight-medium">{{ count($section_lecture) }}
                                                        lectures</span>
                                                </button>
                                            </div><!-- end card-header -->
                                            <div id="collapse{{ $sectnons->id }}" class="collapse show"
                                                aria-labelledby="heading{{ $sectnons->id }}" data-parent="#accordion">
                                                <div class="card-body">
                                                    <ul class="generic-list-item">
                                                        @foreach ($section_lecture as $item)
                                                            <li>
                                                                <div
                                ...
                                <div class="media media-card">
                                    <div class="instructor-img">
                                        <a href="teacher-detail.html" class="media-img d-block">
                                            <img src="{{ !empty($course->user->photo) ? url('upload/instructor_images/' . $course->user->photo) : url('upload/no_image.jpg') }}"
                                                alt="Instructor photo" class="rounded-circle p-1 bg-primary"
                                                width="110">
                                        </a>
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p class="text-black lh-18 pb-3">Phone : {{ $course->user->phone }}</p>
                                        <p class="text-black lh-18 pb-3">Adrress : {{ $course->user->adrress }}</p>
                            ...
                            <div class="card-body">
                                <div class="preview-course-video">
                                    <a href="javascript:void(0)" data-toggle="modal" data-target="#previewModal">
                                        <img src="{{ asset($course->course_image) }}" data-src="images/preview-img.jpg"
        ...
        <div class="container">
            <div class="related-course-wrap">
                ...
                <div class="view-more-carousel-2 owl-action-styled">
                    ...
                    @foreach ($instructorCourses as $course_item)
                        @php
                        ...
                        <div class="card card-item">
                            <div class="card-image">
                                <a href="{{ url('course/details/' . $course_item->id . '/' . $course_item->course_name_slug) }}"
                                    class="d-block">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text"><a href="teacher-detail.html">{{ $course_item['user']['name'] }}</a>
                                </p>
