                                    ...
                                    <div class="lecture-overview-wrap">
                                        ...
                                        <div class="lecture-overview-item">
                                            <div class="lecture-overview-stats-wrap d-flex">
                                                ...
                                                <div class="lecture-overview-stats-item">
                                                    <ul class="generic-list-item">
                                                        <li><span>Resoruse:</span>{{ $course->course->resources }} </li>
                                                ...
                                                <div class="question-list-item">
                                                    ...
                                                    @foreach ($question as $que)
                                                      ...
                                                      @foreach ($reply as $rep)
                                                        ...
                                                        <div
                                                            class="media media-card border-bottom border-bottom-gray py-4 px-3" style="background: #e6e6e6">
                                                            <div
                                                                class="media-img rounded-full flex-shrink-0 avatar-sm">
                                                           <img src="{{ !empty($rep->instructor->photo) ? url('upload/instructor_images/' . $rep->instructor->photo) : url('upload/no_image.jpg') }}"class="user-img">
                                                            </div>
                                                            <div class="media-body">
                                                                <div
                                                                    class="d-flex align-items-center justify-content-between">
                                                                    <div class="question-meta-content">
                                                                        <a href="javascript:void(0)" class="d-block">
                                                                            ...
                                                                            <p class="text-truncate fs-15 text-gray">{{ $rep->question }}
                                                                            </p>
                                                                        </a>
                                                                    </div><!-- end question-meta-content -->
                                ...
                                <div class="col-lg-3 responsive-column-half">
                                    <div class="footer-item">
                                        ...
                                        <ul class="generic-list-item pt-4">
                                            ...
                                            <li>Bangladesh, Dhaka, Narsingdi</li>
                                        </ul>
                                    </div><!-- end footer-item -->
                                </div><!-- end col-lg-3 -->
                                <div class="col-lg-3 responsive-column-half">
